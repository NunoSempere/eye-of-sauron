...
def main():
    ...
    while True:
        try:
            logger.info("Starting globalbiodefense.com processing")
            ...
            logger.info("Finished processing <https://globalbiodefense.com> sleeping for 1h")
            time.sleep(3600)  # TODO: Replace with appropriate duration in seconds
